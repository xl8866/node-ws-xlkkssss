...
const UUID = process.env.UUID || '63afbda6-c992-44ad-ba38-8e3f09842255'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'T4RbI87SfRzp2ZYCLuoXra58Z8hrJtPe';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
